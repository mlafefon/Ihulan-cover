...
const TemplatesPage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    return (
        <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 ${selectingTemplateId ? 'opacity-50 pointer-events-none' : ''}`}>
          {filteredTemplates.map(template => {
            ...
            return (
                <div key={template.id} className="group relative flex flex-col">
                    ...
                    <div className="w-full flex justify-center items-center mt-3 relative px-2">
