...
import { ColorPickerIcon, BanIcon, PlusIcon } from '../Icons';
        ...
        >
            <div className="p-2">
                <div className="flex items-center gap-2 mb-3">
                    <button onClick={handleEyeDropper} className="p-2 rounded-full hover:bg-slate-700" title="טפטפת"><ColorPickerIcon className="w-5 h-5" /></button>
